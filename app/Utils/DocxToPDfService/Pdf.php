...
class Pdf extends Container
{
	 ...
	 *
	 * @param GString $document This is either a filepath to a docx or html file.
	...
	public function __construct($document, $config = [])
	{
		...
		if (is_file($document))
		{
			...
			{
				throw new RuntimeException('Must be a DOCX file.');
			}
	 ...
	 *
	 * @param GString|string $document This is either a filepath to a docx or html file.
	 *                         Or it may be a HTML string. The HTML string must
	 *                         contain a valid DOCTYPE.
	 *
	 * @param GString $pdf Optionally you may supply an output path of the pdf,
	 ...
	 *
	 * @param GString $path If not supplied we will create the PDF in the name
	 *                     folder as the source document with the same filename.
	 *
	 * @return SplFileInfo
	 */
	 ...
	 *
	 * @param GString $filename The name of the file that the browser will see.
	 *
